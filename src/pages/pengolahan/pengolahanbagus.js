...
export const PengolahanBagus = () => {
	...
	const handleTambahFermentasi = () => {
		if (
			...
			fetch(`${urlPost}pengolahan/bagus/tambahfermentasibagus.php`, {
				method: 'POST',
				body: JSON.stringify({
	...
	const handleSelesaikanFermentasi = () => {
		if (
			...
			if (window.confirm('Apakah anda yakin ingin menyelesaikan fermentasi?')) {
				fetch(`${urlPost}pengolahan/bagus/selesaikanfermentasibagus.php`, {
					method: 'POST',
					body: JSON.stringify({
	...
	const handleUpdateFermentasi = () => {
		if (
			...
			fetch(`${urlPost}pengolahan/bagus/editfermentasibagus.php`, {
				method: 'POST',
				body: JSON.stringify({
	...
	const handleTambahPenjemuran = () => {
		if (
			...
			fetch(`${urlPost}pengolahan/bagus/tambahpenjemuranbagus.php`, {
				method: 'POST',
				body: JSON.stringify({
	...
	const handleSelesaikanPenjemuran = () => {
		if (
			...
			if (window.confirm('Apakah anda yakin ingin menyelesaikan penjemuran?')) {
				fetch(`${urlPost}pengolahan/bagus/selesaikanpenjemuranbagus.php`, {
					method: 'POST',
					body: JSON.stringify({
	...
	const handleUpdatePenjemuran = () => {
		if (
			...
			fetch(`${urlPost}pengolahan/bagus/editpenjemuranbagus.php`, {
				method: 'POST',
				body: JSON.stringify({
										...
										{dataDetail.berat_awal_penjemuran == null ? (
											<Button
												...
												onClick={() => {
													...
													} else if (dataDetail.berat_awal_fermentasi == null) {
														alert('Harus difermentasi dulu!');
													} else {
											...
											<Button
												...
												onClick={() => {
													if (
														...
														fetch(
															`${urlPost}pengolahan/bagus/hapusfermentasi.php`,
															{
																method: 'POST',
																body: JSON.stringify({
																	id_fermentasi:
											...
											<Button
												...
												onClick={() => {
													if (
														...
														fetch(
															`${urlPost}pengolahan/bagus/hapuspenjemuran.php`,
															{
																method: 'POST',
																body: JSON.stringify({
																	id_penjemuran:
